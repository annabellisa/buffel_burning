...
str_plot_V11<-function(K,cluster.data,site.data,las.opt,yaxs.loc,col.pal,...){
  ...
  # Plot: ### UP TO HERE:
  par(mar=c(5,1,1,0),mgp=c(1,yaxs.loc+1,yaxs.loc),xpd=F)
  p1<-barplot(dat.thisrun,cex.axis=1.5,col=cols.thisrun,space=0,border=cols.thisrun,xaxt="n",yaxt="n",las=las.opt,ylab="",cex.lab=1.5)
